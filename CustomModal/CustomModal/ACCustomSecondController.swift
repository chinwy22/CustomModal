//
//  ACCustomSecondController.swift
//  CustomModal
//
...
class ACCustomSecondController: UIViewController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let popGesture = UIScreenEdgePanGestureRecognizer(target: self, action: #selector(ACCustomSecondController.handlePopRecognizer(_:)))
    ...
    func navigationController(_ navigationController: UINavigationController, animationControllerFor operation: UINavigationControllerOperation, from fromVC: UIViewController, to toVC: UIViewController) -> UIViewControllerAnimatedTransitioning? {
        if fromVC.isEqual(self) && toVC is ACCustomFirstController {
            return ACCustomPopAnimation()
        }
        return nil
    }
    
    func navigationController(_ navigationController: UINavigationController, interactionControllerFor animationController: UIViewControllerAnimatedTransitioning) -> UIViewControllerInteractiveTransitioning? {
        if animationController is ACCustomPopAnimation {
